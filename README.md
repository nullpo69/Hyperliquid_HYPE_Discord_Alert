...
Discord通知では、OIドロップ額とドロップ率をそれぞれ絵文字で強度表示します。減少量が大きいほど `💥` が増え、タイトルはドロップ率、本文はドロップ額・率の各強度と、同じ5分／15分期間における価格変動率を示します。段階値は額が `$50k / $150k / $300k / $500k / $1m`、率が `4% / 7% / 10% / 15% / 25%` です。
